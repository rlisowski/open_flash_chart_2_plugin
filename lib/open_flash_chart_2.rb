...
'#{width}', '#{height}','9.0.0', 'expressInstall.swf'
  ...
  class YAxisBase
    include OWJSON
    # instance variables
    # stroke tick_length colour min max steps labels
  ...
  class XAxis
    include OWJSON
    # instance variables
    # stroke tick_length colour tick_height grid_colour min max steps labels offset
  ...
  class Graph
    include OWJSON
    # instance variables
    # title x_axis y_axis y_axis_right x_legend y_legend bg_colour elements
  ...
  class LineBase
    ...
    # values width colour font_size dot_size halo_size text
  ...
  class AreaHollow
    ...
    # width color values dot_size text font_size fill_alpha
  ...
  class BarBase
    ...
    # alpha colour values text font_size
  ...
  class Value
    ...
    #top colour tip
    #    %w(top colour tip).each do |method|
    #      define_method("set_#{method}") do |a|
    #        self.instance_variable_set("@#{method.gsub('_','__')}", a)
    #      end
    #      define_method("#{method}=") do |a|
  ...
  class Pie
    ...
    # colours alpha border values animate start_angle
